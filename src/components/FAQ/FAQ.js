...
const FAQ = () => {
  return (
    <div className="py-20 px-20 bg-slate-50">
      <h2 className="md:text-5xl text-3xl  text-center font-medium my-3 mb-10">
        FAQ
      </h2>
      <div className="w-full  grid md:grid-cols-2 gap-10 mt-20">
        <div className="">
          <div id="accordion-open" data-accordion="open" className="shadow-2xl">
            ...
            <h2 id="accordion-open-heading-1">
              ...
              >
                <span class="flex items-center">
                  ...
                  What is difference between Block element and Inline element in
                  HTML?
                </span>
                <svg
                  data-accordion-icon=""
            ...
            >
              <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <p class="mb-2 text-gray-500 dark:text-gray-400">
                  ...
                  inline block the difference is that inline block allows to set
                  height and width in the elements. And with inline block
                  elements the top and bottom margins and paddings are respected
                  but inline block elements are not. Compared to block elements
                  the major difference is that inline block elements does not
                  add a line break after the elements thats why elements can sit
                  next to others elements. Some inline elements are anchor tag,
                  button tag, image tag, input tag, span tag. And some of block
                  elements are header tag, div tag, footer tag, paragraph tag,
                  ul/li tag.
                </p>
              </div>
            </div>
